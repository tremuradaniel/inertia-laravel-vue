...
vue__WEBPACK_IMPORTED_MODULE_1___default().use(_inertiajs_inertia_vue__WEBPACK_IMPORTED_MODULE_0__.plugin);
      ...
      _c("div", { staticClass: "col-md-6" }, [
        Object.keys(_vm.errors).length > 0
          ? _c("div", { staticClass: "alert alert-danger mt-4" }, [
              _vm._v(
                "\n        " +
                  _vm._s(_vm.errors[Object.keys(_vm.errors)[0]]) +
                  "\n      "
              )
            ])
          : _vm._e(),
...
var render = function() {
  ...
  return _c("layout", [
    _c("div", [
      ...
      _vm._v(" "),
      _c("h5", [_vm._v("Foo: " + _vm._s(_vm.foo))])
    ])
  ])
}
var staticRenderFns = []
